...
public abstract class ArrayNodes {
    ...
    public abstract static class CompactNode extends ArrayCoreMethodNode {
        ...
        @Specialization(guards = { "strategy.isMutable()", "strategy.matches(array)", "!strategy.accepts(nil())" }, limit = "ARRAY_STRATEGIES")
        ...
        @Specialization(guards = { "!strategy.isMutable()", "strategy.matches(array)", "!mutableStrategy.accepts(nil())" }, limit = "ARRAY_STRATEGIES")
        public DynamicObject compactPrimitiveNonMutable(DynamicObject array,
                @Cached("of(array)") ArrayStrategy strategy,
    ...
    public abstract static class CompactBangNode extends ArrayCoreMethodNode {
        ...
        @Specialization(guards = { "!strategy.isMutable()", "strategy.matches(array)", "!mutableStrategy.accepts(nil())" }, limit = "ARRAY_STRATEGIES")
        public DynamicObject compactNotObjectsNonMutable(DynamicObject array,
                @Cached("of(array)") ArrayStrategy strategy,
                @Cached("strategy.generalizeForMutation()") ArrayStrategy mutableStrategy) {
            return nil();
        }
